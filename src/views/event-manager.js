    ...
    <div className="event-manager-container">
      ...
      <div className="event-manager-i-phone8plus-createan-event">
        ...
        <div className="event-manager-eventos-concluidos">
          <div className="event-manager-group6">
            ...
            <div className="event-manager-group7">
              <img
                alt="Vector1087"
                src="/playground_assets/vector1087-rlx.svg"
                className="event-manager-vector08"
              />
              <img
                alt="Vector1087"
                src="/playground_assets/vector1087-d32.svg"
                className="event-manager-vector09"
              />
            </div>
            <span className="event-manager-text25">
              <span>Algum lugar</span>
            </span>
            <span className="event-manager-text27">
            ...
            <div className="event-manager-buttongo1">
              <img
                alt="arrowup1088"
